# <img src="https://github.com/Jahans3/use-simple-state/blob/master/uss-logo.png" width="250">

A simple, dependency-free state manager for React, built using hooks.
